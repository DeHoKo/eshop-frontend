...
export const CART_ORDER_ADD_REQUEST = "ORDER_ADD_REQUEST";
export const CART_ORDER_ADD_SUCCESS = "ORDER_ADD_SUCCESS";
export const CART_ORDER_ADD_FAIL = "ORDER_ADD_FAIL";
